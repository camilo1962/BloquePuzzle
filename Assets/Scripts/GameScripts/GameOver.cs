...
public class GameOver : MonoBehaviour
{
    ...
    /// <summary>
    /// Esto navegará a la pantalla de inicio.
    /// </summary>
    ...
    /// <summary>
    /// Pon el código aquí para compartir el juego, la puntuación, etc. en la red social.
    /// </summary>
    ...
    /// <summary>
    /// Pon tu código aquí para abrir la tabla de clasificación.
    /// </summary>
    public void OnLeaderboardButtonPressed ()
	{
		if (InputManager.instance.canInput ()) {
			AudioManager.instance.PlayButtonClickSound ();
			Debug.Log ("Las cosas abiertas de Leaderbord van aquí..");
